...
import { FiUser, FiSettings, FiBarChart2, FiExternalLink } from "react-icons/fi";
import "./Admin.css";
        ...
        <div className="dashboard-content">
          <div className="stats-grid">
            <div className="stat-card">
              <h3>Projects</h3>
              <div className="stat-number">{dashboardData?.stats?.projectsCount || 0}</div>
            </div>
            <div className="stat-card">
              <h3>Skills</h3>
              <div className="stat-number">{dashboardData?.stats?.skillsCount || 0}</div>
            </div>
            <div className="stat-card">
              <h3>Testimonials</h3>
              <div className="stat-number">{dashboardData?.stats?.testimonialsCount || 0}</div>
            </div>
          </div>
